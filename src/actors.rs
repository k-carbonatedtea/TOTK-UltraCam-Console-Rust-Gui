/// Actor 列表 — 从 Python request_spawn.py 完整移植
///
/// 包含 TOTK 中所有可生成的 160+ 个敌人/boss Actor 名称。

pub const ACTOR_LIST: &[&str] = &[
...
/// 随机选择一个 Actor
pub fn random_actor() -> &'static str {
    use rand::Rng;
    let idx = rand::thread_rng().gen_range(0..ACTOR_LIST.len());
    ACTOR_LIST[idx]
}
